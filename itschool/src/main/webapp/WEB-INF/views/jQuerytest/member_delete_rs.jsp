...
<div class="container">
	...
	<div class="col-sm-4" style="border:3px solid #00C6ED; border-radius: 4px;">
		...
		<div class="row" style="margin-bottom: 10px;">
			<center><button Type="button" onclick="location.href='memberdelete?id=${id}'" id="ok" class="btn btn-warning" >확인</button>
			<button Type="button" onclick="location.href='list'" id="cancel" class="btn btn-warning" >취소</button></center>
		</div>
	</div>
	<div class="col-sm-4"></div>
</div>
