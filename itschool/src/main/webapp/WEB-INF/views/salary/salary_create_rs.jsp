...
<div class="container">
	...
	<div class="col-sm-4" style="border:3px solid #00C6ED; border-radius: 4px;">
		<div class="row" style="text-align:center; margin-top: 10px;">
			<font size="6" color="#f0ad4e" style="font-family:inherit; font-weight:bold;">월급여 생성 확인</font>
		</div>
		...
		<div class="row" style="margin-bottom: 10px;">
			<center><button Type="button" onclick="location.href='salary_delete?no=${no}'" id="ok" class="btn btn-warning" >확인</button>
			<button Type="button" onclick="location.href='home'" id="cancel" class="btn btn-warning" >취소</button></center>
		</div>
	</div>
	<div class="col-sm-4"></div>
</div>
